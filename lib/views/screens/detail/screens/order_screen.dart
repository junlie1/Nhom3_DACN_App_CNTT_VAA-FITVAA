...
import 'package:dacn_nhom3_customer/views/screens/detail/screens/order_detail_screen.dart';
...
class _OrderScreenState extends ConsumerState<OrderScreen> {
  ...
  Future<void> _deleteOrder(String orderId, bool shipping) async {
    final OrderController orderController = OrderController();
    try {
      await orderController.deleteOrder(id: orderId, shipping: shipping, context: context);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: orders.isEmpty
      ? const Text("Bạn chưa order sản phẩm nào cả")
      : ListView.builder(
